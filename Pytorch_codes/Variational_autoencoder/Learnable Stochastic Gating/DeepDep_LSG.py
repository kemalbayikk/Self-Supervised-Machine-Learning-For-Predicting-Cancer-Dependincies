...
def train_model(model, train_loader, test_loader, num_epoch, patience, learning_rate):
    ...
    for epoch in range(num_epoch):
        ...
        wandb.log({
            ...
            "epoch": epoch + 1,
            "gate_values": gate_values.tolist()  # gate değerlerini loglama
        })
        ...
        if test_loss < best_loss:
            ...
            torch.save(best_model_state_dict, 'best_model_vae_64batch_LSG.pth')
            print("Model saved")
        else:
            epochs_no_improve += 1
...
if __name__ == '__main__':
    ...
    wandb.init(project="Self-Supervised-Machine-Learning-For-Predicting-Cancer-Dependencies", entity="kemal-bayik", name=f"Just_NN_{ccl_size}CCL_{current_time}_64batch_LSG")
    ...
    # Save the best model
    torch.save(best_model_state_dict, 'results/models/deepdep_vae_model_64batch_LSG.pth')
