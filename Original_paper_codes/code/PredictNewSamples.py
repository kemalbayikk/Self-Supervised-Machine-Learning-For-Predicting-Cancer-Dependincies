...
if __name__ == '__main__':
    ...
    model_saved = models.load_model("PytorchStaticSplits/OriginalCode/Results/Split3/model_full_3.h5" % model_name)
    ...
    batch_size = 500
    first_to_predict = data_mut_tcga.shape[0]
    ...
    pd.DataFrame.to_csv(data_pred_df, path_or_buf="PytorchStaticSplits/OriginalCode/Results/Split3/predictions/tcga_predicted_data_%s_demo.txt" % model_name, sep='\t', index_label='CRISPR_GENE', float_format='%.4f')
    print("\n\nPrediction completed in %.1f mins.\nResults saved in PytorchStaticSplits/OriginalCode/Results/Split3/predictions/tcga_predicted_data_%s_demo.txt\n\n" % (
