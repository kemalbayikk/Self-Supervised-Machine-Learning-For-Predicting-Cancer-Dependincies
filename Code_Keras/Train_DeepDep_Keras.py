...
if __name__ == '__main__':
    ...
    predictions = model_final.predict([data_mut[id_test], data_exp[id_test], data_cna[id_test], data_meth[id_test], data_fprint[id_test]])
    pearson_corr, _ = pearsonr(predictions.flatten(), data_dep[id_test].flatten())
